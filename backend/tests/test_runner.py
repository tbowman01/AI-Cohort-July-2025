...
def validate_test_environment():
    ...
    try:
        subprocess.run(["python", "-c", "import fastapi"], 
                      capture_output=True, check=True)
    ...
    try:
        subprocess.run(["python", "-c", "import sqlalchemy"], 
                      capture_output=True, check=True)
...
def main():
    ...
    parser.add_argument("--file", type=str, 
                       help="Run tests from specific file (e.g., test_main.py)")
    ...
    parser.add_argument("--ai-service", action="store_true",
